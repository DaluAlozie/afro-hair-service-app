...
export default function BusinessRescheduleButton({ appointmentId, startTime, endTime, customerId, businessId }: EditButtonProps) {
    ...
    const onPress = () => {
        if (isAtLeastThreeDaysFromToday(startTime)) {
            router.push(`/myBusiness/rescheduleBooking?${queryParams}`)
        }
        else {
