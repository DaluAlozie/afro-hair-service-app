import { AddVariantForm } from '@/components/business/variant/AddVarientForm';
...
export default function AddVariant() {
  ...
  return (
    <View onLayout={onLayout}>
        {
            validParams &&
            <AddVariantForm serviceId={parseInt(serviceId as string)} serviceOptionId={parseInt(serviceOptionId as string)}/>
        }
    </View>
  )
}
